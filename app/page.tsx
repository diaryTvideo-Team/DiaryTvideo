    ...
    <main className="min-h-screen bg-background">
      ...
      <header className="border-b border-border">
        <div className="mx-auto max-w-6xl px-4 py-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-serif text-xl font-semibold text-foreground">{t.myDiary}</span>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">{t.heroDescription}</p>
      ...
      <section className="bg-secondary/30 border-y border-border">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
          <h2 className="font-serif text-2xl font-semibold text-foreground text-center mb-12">{t.whyDigitalDiary}</h2>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <FeatureCard icon={<PenLine className="h-6 w-6" />} title={t.easyWriting} description={t.easyWritingDesc} />
            <FeatureCard
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 text-center">
        <h2 className="font-serif text-2xl font-semibold text-foreground mb-4">{t.readyToStart}</h2>
